...
- Active phase: Phase 5 (UX completion and E2E reliability).
- Remaining work: implement remaining user-facing TODO paths and convert critical E2E scenarios to running coverage.
